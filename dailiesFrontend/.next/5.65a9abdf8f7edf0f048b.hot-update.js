  ...
  _createClass(GWFractalsRow, [{
    ...
    value: function componentDidMount() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(GW2ACHIEVEMENTURL + this.props.data.id).then(function (res) {
        ...
        _this2.state.infoArr = res.data; //console.log(this.state.infoArr[0].name);

        _this2.state.titleString = _this2.state.infoArr[0].name;
      });
    }
  }, {
    key: "render",
...
function (_Component2) {
  ...
  function GWFractals() {
    ...
    return _possibleConstructorReturn(_this3, (_temp2 = _this3 = _possibleConstructorReturn(this, (_ref2 = GWFractals.__proto__ || Object.getPrototypeOf(GWFractals)).call.apply(_ref2, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this3), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
  ...
  _createClass(GWFractals, [{
    ...
    value: function componentDidMount() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(GW2ACHIEVEMENTURL + this.props.data.id).then(function (res) {
        //console.log(res.data);
        _this4.state.infoArr = res.data; //console.log(this.state.infoArr[0].name);

        _this4.state.titleString = _this4.state.infoArr[0].name;
      });
    }
  }, {
    key: "render",
...
function (_Component3) {
  ...
  function JStest() {
    ...
    return _possibleConstructorReturn(_this5, (_temp3 = _this5 = _possibleConstructorReturn(this, (_ref3 = JStest.__proto__ || Object.getPrototypeOf(JStest)).call.apply(_ref3, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this5), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
...
//# sourceMappingURL=5.65a9abdf8f7edf0f048b.hot-update.js.map