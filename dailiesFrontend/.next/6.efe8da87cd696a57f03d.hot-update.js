...
function (_Component3) {
  ...
  _createClass(DailyRow, [{
    ...
    value: function hasDailyReset() {
      ...
      if (Date.parse(this.props.data.reset + UTCstringmodifier) <= dateFormat) {//if(this.props.data.resetTime < )
      }
...
//# sourceMappingURL=6.efe8da87cd696a57f03d.hot-update.js.map