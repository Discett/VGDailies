  ...
  _createClass(GWFractals, [{
    ...
    value: function getTitles() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(GW2ACHIEVEMENTURL + this.state.stringID).then(function (res) {
        res.data.forEach(function (data) {
          //TODO: find out why it isn't pushing proper props into row
          _this3.state.rows.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(GWFractalRow, {
            data: data,
            key: data.name,
            __source: {
              fileName: _jsxFileName,
          ...
          console.log(_this3.state.stringID);
        });
      });
      return rows;
    }
...
//# sourceMappingURL=5.5f6205a5bc8f65276341.hot-update.js.map