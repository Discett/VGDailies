...
/*#__PURE__*/
function (_Component) {
  _inherits(GWFractals, _Component);
...
function (_Component2) {
  ...
  function JStest() {
    ...
    return _possibleConstructorReturn(_this2, (_temp = _this2 = _possibleConstructorReturn(this, (_ref = JStest.__proto__ || Object.getPrototypeOf(JStest)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this2), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
...
//# sourceMappingURL=5.5db5a8adaa3bb5a8f899.hot-update.js.map