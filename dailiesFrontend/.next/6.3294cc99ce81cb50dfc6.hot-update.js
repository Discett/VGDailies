  ...
  _createClass(DailyRow, [{
    ...
    value: function setFinishDaily() {
      ...
      __WEBPACK_IMPORTED_MODULE_5_axios___default()({
        ...
        this.updateTime(this.props.data.title, dataFormat);
        console.log('success');
      }.bind(this)).catch(function (error) {
        console.log(error);
      });
...
function (_Component6) {
  ...
  function DailyDataBox(props) {
    ...
    _this7.updatetime = _this7.updateTime.bind(_assertThisInitialized(_this7));
    return _this7;
  }
  ...
  _createClass(DailyDataBox, [{
    ...
    key: "updateTime",
    value: function updateTime(title, time) {
      var updateData = this.state.dailyData;
      ...
      for (var i = 0; i < updateData.length; i++) {
        ...
        if (title == updateData[i].fields.title) {
          updateData[i].fields.reset = time;
          this.setState({
            dailyData: updateData
          });
        }
...
//# sourceMappingURL=6.3294cc99ce81cb50dfc6.hot-update.js.map