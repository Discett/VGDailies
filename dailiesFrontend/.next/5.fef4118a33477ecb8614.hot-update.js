    ...
    value: function handleSubmit(e) {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default()({
        ...
        if (response.data != "incorrect username or password") {
          var username = this.state.userSubmittedUsername;
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("credentialsContext", {
            __source: {
              fileName: _jsxFileName,
              lineNumber: 48
            }
          }, __WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.username = this.state.userSubmittedUsername, __WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.token = response.data, console.log(__WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.token));
        }
...
//# sourceMappingURL=5.fef4118a33477ecb8614.hot-update.js.map