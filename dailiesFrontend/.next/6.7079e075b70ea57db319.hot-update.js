...
function (_Component3) {
  ...
  _createClass(DailyRow, [{
    ...
    value: function setFinishDaily() {
      ...
      console.log(Date.parse(dateFormat));
    ...
    value: function hasDailyReset() {
      ...
      var today = new Date();
      console.log(Date.parse(this.props.data.reset + UTCstringmodifier) - Date.now());
      console.log(1000 * 60 * 60 * 24);
      var dateFormat = today.getFullYear() + '-' + today.getMonth() + '-' + today.getDate() + UTCstringmodifier; //TODO: incorporate time with this

      if (Date.parse(this.props.data.reset + UTCstringmodifier) - Date.now() < 1000 * 60 * 60 * 24 + 1000 * 10) {
...
//# sourceMappingURL=6.7079e075b70ea57db319.hot-update.js.map