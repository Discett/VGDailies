...
function (_Component) {
  ...
  _createClass(Login, [{
    ...
    value: function handleSubmit(e) {
      ...
      }, __WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.username = this.state.userSubmittedUsername);
      __WEBPACK_IMPORTED_MODULE_1_axios___default()({
        ...
        if (response.data != "incorrect username or password") {
          ...
          }, __WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.token = response.data, console.log(__WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.token), console.log(__WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.username));
        }
...
//# sourceMappingURL=5.ca2346da883b1bb7e9ca.hot-update.js.map