...
function (_Component3) {
  ...
  _createClass(DailyRow, [{
    ...
    value: function hasDailyReset() {
      ...
      var UTCstringmodifiertest = 'T' + this.props.data.resetTime;
      console.log('hasDailyReset');
      var resetDate = new Date();
      resetDate.setTime(Date.parse(this.props.data.reset + UTCstringmodifier));
      console.log('reset date');
      console.log(resetDate);
      console.log(UTCstringmodifiertest); //TODO: incorporate time with this
...
//# sourceMappingURL=6.e548060374b9e63cc46d.hot-update.js.map