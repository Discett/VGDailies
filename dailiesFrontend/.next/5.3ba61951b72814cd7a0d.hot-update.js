    ...
    value: function handleSubmit(e) {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default()({
        ...
        if (response.data != "incorrect username or password") {
          ...
          }, __WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.username = userSubmittedUsername, __WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.token = response.data, console.log(__WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.username), console.log(__WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.token));
        }
...
//# sourceMappingURL=5.3ba61951b72814cd7a0d.hot-update.js.map