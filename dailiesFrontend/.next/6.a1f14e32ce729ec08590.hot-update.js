...
function (_Component3) {
  ...
  _createClass(DailyRow, [{
    ...
    value: function hasDailyReset() {
      ...
      if (Date.now() - Date.parse(this.props.data.reset + UTCstringmodifier) < Date.now() - (Date.now() - 1000 * 60 * 60 * 24)) {
...
//# sourceMappingURL=6.a1f14e32ce729ec08590.hot-update.js.map