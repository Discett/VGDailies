  ...
  _createClass(GWFractalsRow, [{
    ...
    value: function componentDidMount() {
      __WEBPACK_IMPORTED_MODULE_1_axios___default()({
        method: 'get',
        url: GW2ACHIEVEMENTURL + this.props.data.id,
        responseType: 'json'
      }).then(function (response) {
        console.log(GW2GW2ACHIEVEMENTURL + this.props.data.id);
        this.state.titleString = response.name;
      });
    }
  }, {
    key: "render",
...
//# sourceMappingURL=5.3af70041dd7205db19e2.hot-update.js.map