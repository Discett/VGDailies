...
function (_Component3) {
  ...
  _createClass(DailyRow, [{
    ...
    value: function hasDailyReset() {
      ...
      var resetDate = new Date(); //resetDate.setDate(Date.parse(this.props.data.reset + UTCstringmodifier));

      console.log('reset date');
      console.log(resetDate); //TODO: incorporate time with this
...
//# sourceMappingURL=6.9f8157dec9bf3a52a08a.hot-update.js.map