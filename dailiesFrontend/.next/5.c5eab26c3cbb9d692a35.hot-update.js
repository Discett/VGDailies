...
function (_Component) {
  ...
  _createClass(Login, [{
    ...
    value: function handleSubmit(e) {
      ...
      }, console.log(__WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.username), console.log(__WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.token));
      __WEBPACK_IMPORTED_MODULE_1_axios___default()({
        ...
        if (response.data != "incorrect username or password") {
          ...
          }, __WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.username = this.state.userSubmittedUsername, __WEBPACK_IMPORTED_MODULE_2__credentials__["a" /* credentials */].user.token = response.data);
        }
...
//# sourceMappingURL=5.c5eab26c3cbb9d692a35.hot-update.js.map