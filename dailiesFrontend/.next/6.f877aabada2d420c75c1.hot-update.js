...
function (_Component3) {
  ...
  _createClass(DailyRow, [{
    ...
    value: function setFinishDaily() {
      ...
      console.log('today');
      console.log(today); //tomorrow.setDate(today.getDate()+1);
    ...
    value: function hasDailyReset() {
      ...
      if (Date.now() - Date.parse(this.props.data.reset + UTCstringmodifier)) {//if(this.props.data.resetTime < )
      }
...
//# sourceMappingURL=6.f877aabada2d420c75c1.hot-update.js.map