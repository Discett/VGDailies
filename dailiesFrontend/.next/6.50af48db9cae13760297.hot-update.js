    ...
    value: function updateRemove(removed) {
      ...
      for (var i = 0; i < updateData.length; i++) {
        ...
        if (removed == updateData[i].fields.title) {
          updateData.splice(i, 1); //var cob = {fields:{title:'testData11',reset:null,resetTime:"11:11:00"}};
          //updateData.push(cob);
...
//# sourceMappingURL=6.50af48db9cae13760297.hot-update.js.map