...
function (_Component4) {
  ...
  _createClass(AddDailyInformation, [{
    ...
    value: function handleSubmit(e) {
      ...
      axios({
          method: 'post',
          url: weblinks.link.addUserDaily,
          data: {
      ...
      */
      ...
      console.log(new Date(year, month, day)); //TODO: needs to reference time and data to backend
...
//# sourceMappingURL=6.d9f5c8f7f05404f70ee5.hot-update.js.map