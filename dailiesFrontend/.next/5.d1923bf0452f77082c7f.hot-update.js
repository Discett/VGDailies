...
function (_Component) {
  ...
  _createClass(GWFractals, [{
    ...
    value: function render() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(GW2GW2ACHIEVEMENTURL + this.state.stringOfID).then(function (res) {
        console.log(res);
      });
      console.log(this.state.stringOfID);
...
//# sourceMappingURL=5.d1923bf0452f77082c7f.hot-update.js.map