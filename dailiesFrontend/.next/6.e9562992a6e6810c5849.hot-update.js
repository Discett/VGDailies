  ...
  _createClass(AddDailyInformation, [{
    ...
    value: function handleSubmit(e) {
      ...
      __WEBPACK_IMPORTED_MODULE_5_axios___default()({
        ...
        console.log('success'); //this.props.updateAdd(this.state.title,this.state.time);
...
function (_Component6) {
  ...
  _createClass(DailyDataBox, [{
    ...
    value: function updateAdd(title, time) {
      ...
      updateData.push(updateAddedDaily);
    }
  }, {
    key: "render",
    value: function render() {
...
//# sourceMappingURL=6.e9562992a6e6810c5849.hot-update.js.map