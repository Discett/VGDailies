...
function (_Component) {
  ...
  function GWFractalsRow() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = GWFractalsRow.__proto__ || Object.getPrototypeOf(GWFractalsRow)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      value: {
        titleString: "",
        data: _this.props.data //TODO: needs to put id then get response
  ...
  _createClass(GWFractalsRow, [{
    ...
    value: function componentDidMount() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(GW2ACHIEVEMENTURL + data.id).then(function (res) {
        _this2.setState.titleString = res.name;
      });
    }
  }, {
    key: "render",
...
function (_Component3) {
  ...
  function JStest() {
    ...
    return _possibleConstructorReturn(_this4, (_temp3 = _this4 = _possibleConstructorReturn(this, (_ref3 = JStest.__proto__ || Object.getPrototypeOf(JStest)).call.apply(_ref3, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this4), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
...
//# sourceMappingURL=5.06e972507bbb191df07c.hot-update.js.map