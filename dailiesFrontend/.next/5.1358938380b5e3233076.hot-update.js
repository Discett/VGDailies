...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__credentials__ = __webpack_require__("./pages/credentials.js");
...
function (_Component2) {
  ...
  _createClass(GWFractals, [{
    key: "getTitles",
    value: function () {
      var _getTitles = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get(GW2ACHIEVEMENTURL + this.state.stringID).then(function (res) {
                  res.data.forEach(function (data) {
                    //TODO: find out why it isn't pushing proper props into row
                    rows.push(__WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(GWFractalRow, {
                      data: data,
                      __source: {
                        fileName: _jsxFileName,
                        lineNumber: 35
...
function (_Component3) {
  ...
  _createClass(JStest, [{
    ...
    value: function componentDidMount() {
      ...
      __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get(GW2DAILYURL).then(function (res) {
    ...
    value: function render() {
      ...
      }, "This is a test"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(GWFractals, {
...
//# sourceMappingURL=5.1358938380b5e3233076.hot-update.js.map